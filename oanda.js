...
OANDA.trade.change = function(accountId, tradeId, trailingStop, takeProfit, stopLoss, callback) {
...
OANDA.order.change = function(accountId, orderId, units, price, trailingStop, takeProfit, stopLoss, callback) {
    OANDA.api("/v1/accounts/" + accountId + "/orders/" + orderId, 'PUT', 
    {units:units, price:price, trailingStop : trailingStop, takeProfit : takeProfit, stopLoss : stopLoss}, 
    callback);
}
